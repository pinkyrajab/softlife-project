...
<nav class="navbar navbar-expand-lg navbar-light ">
        <div class="container">
          ...
          <button class="navbar-toggler visible-xs" type="button" data-bs-toggle="collapse" data-bs-target="#navbarTogglerDemo02" aria-controls="navbarTogglerDemo02" aria-expanded="false" aria-label="Toggle navigation">
           ...
           <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav visible-xs ms-auto">
              ...
              <li class="nav-item ">
                <a class="nav-link active" href="#contact"><h7> CONTACT US</h7></a>
              </li>
          ...
          @guest
                  @if (Route::has('login'))
                  <ul id="top_links">
                      <li><a class="nav-link active" href="{{ route('login') }}"> <h7> SIGN IN   </h7> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-left" viewBox="0 0 16 16">
  ...
  <div class="carousel-inner">
    <div class="carousel-item ad1 d-block w-100 active" data-bs-interval="2800">
      <p>WELCOME TO SOFTLIFE <br>ADVENTURES AND TRAVELLERS
        ...
        <marquee class="mycarouselmarquee" direction = "left" scrollamount="22">Where your softlife dreams come true!</marquee></p>
...
<div class="offer">
    ...
    <a id="getstarted"><h4>WHAT WE OFFER</h4></a>
      <div class="row">
        <div class="row">
          <div class="col-sm-12 col-lg-6 col-md-6 hotel_jpg">
            <a href=""><img src="{{ asset('assets/images/hotels/hotelhomepage.jpg') }}" alt="" class="img-fluid"></a>
          ...
          <div class="col-sm-12 col-lg-6 col-md-6">
            <p class="info visible-lg">
              ...
              <p class="more visible-lg"><a href="all_hotel.html"><button class="see_more"><span>SEE MORE</span></button></a></p>
            </p>
          </div>
      </div>
      ...
      <div class="row">
        <div class="col-sm-12 col-lg-6 col-md-6">
          <p class="info visible-lg">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Praesentium, nihil similique. Consequuntur facere explicabo consequatur perferendis recusandae quis non esse rem odio minima, veritatis sapiente cum error distinctio ut! Asperiores.
            <p class="more visible-lg"><a href="all_adventure.html"><button class="see_more"><span>SEE MORE</span></button></a></p>
          </p>
        </div>
  ...
  <br> <br>
  <a href="http://">SIGN UP NOW  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-left" viewBox="0 0 16 16">
    <path fill-rule="evenodd" d="M10 3.5a.5.5 0 0 0-.5-.5h-8a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h8a.5.5 0 0 0 .5-.5v-2a.5.5 0 0 1 1 0v2A1.5 1.5 0 0 1 9.5 14h-8A1.5 1.5 0 0 1 0 12.5v-9A1.5 1.5 0 0 1 1.5 2h8A1.5 1.5 0 0 1 11 3.5v2a.5.5 0 0 1-1 0v-2z"/>
    <path fill-rule="evenodd" d="M4.146 8.354a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H14.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3z"/>
  </svg></a></p>
</div>
