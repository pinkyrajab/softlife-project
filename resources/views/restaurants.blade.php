...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/restaurant.css') }}">
          ...
          <!-- <div class="sort">
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    <li><a class="dropdown-item" href="#">Highest price to lowest</a></li>
                    <li><a class="dropdown-item" href="#">Lowest price to highest</a></li>
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-sm-12 col-md-8">
            <div>
                ...
                <button>Sea food restaurants</button>
                <button>African dishes</button>
            </div>
        </div>
    </div>
