...
<html lang="zxx" class="js">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('backend/assets/css/editors/tinymce.css') }}">
    ...
    <body class="nk-body npc-default">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                                                ...
                                                <div class="dropdown-inner">
                                                    <ul class="link-list">
                                                        ...
                                                        <li><a class="dark-switch" href="#" id="toggle-dark"><em class="icon ni ni-moon"></em><span>Dark Mode</span></a></li>
                                                    </ul>
                                                </div>
                                                <div class="dropdown-inner">
                                                    <ul class="link-list">
                    ...
                    <div class="nk-sidebar" data-content="sidebarMenu">
                        <div class="nk-sidebar-inner" data-simplebar>
                            <ul class="nk-menu nk-menu-md">
                                ...
                                <li class="nk-menu-item">
                                    <a href="{{ route('home') }}" class="nk-menu-link" target="_blank">
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="{{ route('admin.locations') }}" class="nk-menu-link"><span class="nk-menu-text">All Locations </span></a>
                                        </li>
                                    </ul><!-- .nk-menu-sub -->
                                </li><!-- .nk-menu-item -->
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="{{ route('admin.tours') }}" class="nk-menu-link"><span class="nk-menu-text">All Tours </span></a>
                                        </li>
                                    </ul><!-- .nk-menu-sub -->
                                </li><!-- .nk-menu-item -->
        ...
        <script src="{{ asset('backend/assets/js/libs/editors/tinymce.js') }}"></script>
        <script src="{{ asset('backend/assets/js/editors.js') }}"></script>
